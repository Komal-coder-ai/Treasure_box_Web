...
const OrderDetails = () => {
  ...
  const getDetails = async () => {
    ...
    try {
      ...
      if (result?.data?.status) {
        ...
        const productId = result?.data?.data?.All_Orderd_Product[0]?.productId;
  ...
  return (
    <>
            ...
            <div className="deliveryAddressNameNumber">
              <div className="deliveryAddressNameNumber_fluid">
                <div className="">
                  ...
                  <p className="deliveryNumberPara">
      ...
      {/* <Product_Comments productId={productId}></Product_Comments> */}
      <Product_Comments productIdFk={160} />
